// 'use babel';
// // Test cases will be added in next release
...
// //   });
// //
// //   describe('when the Generate package event is triggered', () => {
// //     it('hides and shows the modal panel with the form generated', () => {
// //       // Before the activation event the view is not on the DOM, and no panel
// //       // has been created
// //       executeCommand(() => expect(workspaceElement.querySelector('.html-template-generator')).not.toExist())
// //       atom.commands.dispatch(workspaceElement, 'html-template-generator:generate');
// //       executeCommand(() => expect(workspaceElement.querySelector('.html-template-generator')).toExist())
